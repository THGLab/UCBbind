...
#CHARISOSMILEN = 64
CHARISOSMILEN = max(CHARISOSMISET.values())
...
def collate_fn(batch_data,max_d=100,max_p=1200):
    ...
    for i,pair in enumerate(batch_data):
        ...
        smiles_list.append(compoundstr)
        sequence_list.append(proteinstr)

    return (compound_new, protein_new, labels_new, smiles_list, sequence_list)
